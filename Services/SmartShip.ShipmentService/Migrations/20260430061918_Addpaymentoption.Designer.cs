...
namespace SmartShip.ShipmentService.Migrations
{
    ...
    [Migration("20260430061918_Addpaymentoption")]
    partial class Addpaymentoption
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartShip.ShipmentService.Domain.Entities.ShipmentRoute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ShipmentId", "SequenceOrder")
                        .IsUnique();

                    b.ToTable("ShipmentRoutes");
                });
            ...
            modelBuilder.Entity("SmartShip.ShipmentService.Domain.Entities.ShipmentRoute", b =>
                {
                    b.HasOne("SmartShip.ShipmentService.Domain.Entities.Shipment", "Shipment")
                        .WithMany()
